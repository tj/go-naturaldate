...
func (p *parser) Init(options ...func(*parser) error) error {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l287:
				add(ruleWhitespace, position286)
			}
			return true
		l285:
